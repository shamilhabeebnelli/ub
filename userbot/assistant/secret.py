    ...
    if os.path.exists("./userbot/secrets.txt"):
        ...
        try:
            ...
            if event.query.user_id in ids:
                ...
                reply_pop_up_alert = "Go away stupid, Dont poke your hands on others nikker, idiot"
        except KeyError:
            reply_pop_up_alert = "This message no longer available on shamil's UB server"
    else:
